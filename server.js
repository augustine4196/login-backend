...
// CRITICAL FIX FOR LOGIN/SIGNUP: Use the modern, built-in Express parsers.
// This is safer and replaces the old `bodyParser`.
...
io.on('connection', (socket) => {
    ...
    // All other socket listeners (accept-challenge, webrtc, game-sync) go here.
    // ...
});
